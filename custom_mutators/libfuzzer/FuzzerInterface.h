...
// extern "C" int LLVMFuzzerTestOneInput2(const uint8_t *Data, size_t Size);
...
// Must return 0.
FUZZER_INTERFACE_VISIBILITY int LLVMFuzzerInitialize2(int *argc, char ***argv);
...
// Returns the new size, which is not greater than MaxSize.
FUZZER_INTERFACE_VISIBILITY size_t
LLVMFuzzerMutate2(uint8_t *Data, size_t Size, size_t MaxSize);
